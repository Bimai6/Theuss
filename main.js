const taskInput = document.getElementById("add_new_task_input");

taskInput.addEventListener("click", function handleClick() {
    taskInput.classList.add("no-hover");
    taskInput.innerHTML= `
  ...
  taskInput.removeEventListener("click", handleClick);
});